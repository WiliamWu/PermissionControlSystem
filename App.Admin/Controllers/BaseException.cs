...
namespace App.Admin.Controllers
{
    ...
    public class BaseException
    {
        ...
        public Exception Exception
        {
            get
            {
                return (System.Web.HttpContext.Current.Session["Exception"] as Exception);
            }
            private set
            {
                System.Web.HttpContext.Current.Session["Exception"] = value;
            }
        }
        ...
        public BaseException()
        {
            ...
            try
            {
                this.Exception = System.Web.HttpContext.Current.Application["LastError"] as Exception;
                ...
                System.Web.HttpContext.Current.Session["LastError"] = null;
            }
        ...
        {
            string str = null;
            if (System.Web.HttpContext.Current.Request["ErrorUrl"] != null)
            {
                str = System.Web.HttpContext.Current.Request["ErrorUrl"].ToString();
            }
            return str;
        }
